...
syn keyword plsqlKeyword AGENT AND ANY ARRAY ASSIGN AS AT AUTHID BODY BY
...
syn keyword plsqlKeyword FINAL GOTO HASH IMMEDIATE IN INDICATOR
...
syn keyword plsqlKeyword PARTITION PIPELINED PRAGMA RAISE RANGE REF
